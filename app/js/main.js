...
var Dog = function Dog(parameters) {
  parameters = parameters || {};

  //this.color, hungry, status, owner, cool
  this.color = parameters.color;
  this.hungry = parameters.hungry !== undefined ? parameters.hungry : true;
  this.status = 'normal';
  this.owner = parameters.owner;
  this.cool = parameters.cool;
};
//Human Constructor
var Human = function Human(these) {
  these = these || {};

  //this.cool, feed, pet
  this.cool = these.cool !== undefined ? these.cool : false;
